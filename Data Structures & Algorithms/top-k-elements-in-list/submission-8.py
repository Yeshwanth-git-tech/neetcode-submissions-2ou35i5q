...
class Solution:
    def topKFrequent(self, nums: List[int], k: int) -> List[int]:
        ...
        # #for the last index you neded + 1 ,since it is 0-indexed
        ...
        #     #we have to loop throught hte nested list 
        #     for n in freq[i]:
        #         res.append(n)
        #         if len(res) == k:
        #             return res
        ...
        # print(ordered) #list
        # res = []
        # for num , freq in ordered[:k]:
        #     res.append(num)
            

        # return res

        res = [num for num, freq in ordered[:k]]
        return res
